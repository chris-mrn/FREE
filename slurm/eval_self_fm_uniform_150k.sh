#!/bin/bash
#SBATCH --job-name=eval_sfm_uni_150k
#SBATCH --partition=gpu_lowp
#SBATCH --gres=gpu:l40s:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --time=2:00:00
#SBATCH --output=/nfs/ghome/live/cmarouani/FREE/outputs/cifar10_self_fm_uniform/eval_150k_%j.log
...
echo "=== Self-FM CIFAR-10 — NFE sweep eval, step 150K ==="
echo "Node : $(hostname)"
